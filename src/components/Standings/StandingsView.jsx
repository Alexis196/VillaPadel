            ...
            <div ref={shareRef}>
              {isMobile ? (
                <div className="sv-mobile-list">
                  {standings.length === 0 ? (
                    ...
                    const isTop = pos <= 2
                    return (
                      <div key={row.id} className={`standings-mobile-card ${isTop ? 'standings-mobile-card-highlight' : 'standings-mobile-card-normal'}`}>
                        ...
                        <div className="sv-mobile-stats-bar">
                          ...
                          <div className="sv-mobile-stat">
                            <div className="sv-mobile-stat-label">Diff</div>
                ...
                <div className="table-wrap">
                  <div className="scroll-x">
                    ...
                    {standings.length === 0 ? (
                      ...
                      const isTop = pos <= 2
                      return (
                        <div key={row.id} className={`table-row ${isTop ? 'table-row-highlight' : 'table-row-normal'}`}
              ...
              {standings.length > 0 && (
                <div className="sv-legend">
                  ...
                  <span className="sv-legend-text">Clasifican a playoffs (top 2 por zona)</span>
                </div>
              )}
            </div>
          )}
